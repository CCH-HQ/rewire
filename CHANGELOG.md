...
- Separated OpenCode model IDs, catalog display names, and AI SDK package selection; added SDK-family inference for common GPT, Claude, and Gemini IDs, model-aware workflow preselection, explicit CLI/workflow overrides, and a dedicated OpenCode adapter module.
